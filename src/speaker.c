...
static unsigned char __wiiuse_speaker_vol = 0x40;
static unsigned char __wiiuse_speaker_defconf[7] = { 0x00,0x00,0xD0,0x07,0x40,0x0C,0x0E };
...
u8 wencdata(WENCStatus *info, short sample)
{
	int nibble,delta;
...
void set_speakervol(struct wiimote_t *wm, unsigned char vol)
{
